...
public final class Database {
    ...
    */
    public class func create(path: String, comparator: Comparator, options: [FileOption] = FileOption.standard) throws -> Database {
    ...
    public func write(options: [WriteOption] = WriteOption.standard, _ update: (WriteBatch) -> Void) throws {
        var error: UnsafeMutablePointer<Int8>? = nil
